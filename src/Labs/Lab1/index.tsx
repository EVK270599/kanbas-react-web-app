  ...
  return (
    <div id="wd-lab1">
      ...
      <div id="wd-h-tag">
        ...
        <p>
          For instance, this paragraph is preceded by the heading <strong>Heading Tags</strong>.
          The font of the section headings is usually larger and bolder than their
          subsection headings. This document uses headings to introduce topics
          such as HTML Documents, HTML Tags, Heading Tags, etc.
        </p>
        <p>
      ...
      <div id="wd-images">
        ...
        <img
          ...
          alt="Starship" // Added alt text
        />
        <p>Loading a local image:</p>
        <img
          id="wd-teslabot"
          src="images/Optimus_Tesla.jpg"
          height="200"
          alt="Optimus Tesla" // Added alt text
        />
      </div>
      <div id="wd-forms">
        <h4>Form Elements</h4>
        <form id="wd-text-fields">
          ...
          <input
            ...
            defaultValue="123@#$asd" // Use defaultValue if controlling the input
          />
          <br />
          ...
          <input
            ...
            placeholder="Doe"
            defaultValue="Wonderland" // Use defaultValue if controlling the input
            title="The last name"
          />
          <h5>Text Boxes</h5>
